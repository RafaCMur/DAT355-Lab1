...
public class BowlingAdapterFactory extends AdapterFactoryImpl {
	...
	protected BowlingSwitch<Adapter> modelSwitch =
		new BowlingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMachup(Machup object) {
				return createMachupAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link bowling.Machup <em>Machup</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMachupAdapter() {
		return null;
	}
