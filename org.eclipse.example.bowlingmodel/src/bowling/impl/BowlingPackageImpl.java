...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 * @generated
	 */
	private EClass machupEClass = null;
	 ...
	 * @generated
	 */
	public EReference getTournament_Machups() {
	 ...
	 * @generated
	 */
	public EReference getMachup_Games() {
		return (EReference)machupEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGame_Machup() {
	...
	public void createPackageContents() {
		...
		createEReference(tournamentEClass, TOURNAMENT__MACHUPS);

		machupEClass = createEClass(MACHUP);
		createEReference(machupEClass, MACHUP__GAMES);

		gameEClass = createEClass(GAME);
		createEReference(gameEClass, GAME__MACHUP);
	...
	public void initializePackageContents() {
		...
		initEReference(getTournament_Machups(), this.getMachup(), null, "machups", null, 0, -1, Tournament.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(machupEClass, Machup.class, "Machup", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMachup_Games(), this.getGame(), this.getGame_Machup(), "games", null, 0, 2, Machup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(gameEClass, Game.class, "Game", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGame_Machup(), this.getMachup(), this.getMachup_Games(), "machup", null, 0, 1, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
